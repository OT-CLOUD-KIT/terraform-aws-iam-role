  ...
  roles = [
    {
      name = "example-role"
      path = "/"
      desc = "Example IAM Role"
      trust_policy = {
        policy_template_file = "templates/trust-policy.json"
        policy_template_vars = {
          # Add your template vars here if needed
        }
      }
  ...
  policies = [
    {
      ...
      path                 = "/"
      desc                 = "Example inline policy"
      policy_template_file = "templates/policy.json"
      policy_template_vars = {
